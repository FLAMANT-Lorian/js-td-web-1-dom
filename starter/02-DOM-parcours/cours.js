...
*/
const enfant = document.getElementById('antiques').getElementsByClassName('existe');

// Affiche le nombre d'enfants de l'élément d'identifiant "antiques" ayant la classe "existe"
console.log(enfant.length);
...
// Le premier paragraphe du document
console.log(document.querySelector('body p:first-of-type'));

// Le premier (et seul) enfant de l'élément d'id "antiques" ayant la classe "existe"
console.log(document.querySelector('#antiques> .existe:first-of-type'));
